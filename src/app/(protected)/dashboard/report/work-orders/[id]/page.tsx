...
//     drawSignatureField("Name and Title", reportData.approverNameAndTitle);
//     drawSignatureField("Date of Approval", reportData.dateOfApproval);
...
//           <h1 className="text-3xl font-bold mb-2">KOAN TECHNICAL SERVICES</h1>
...
//               </label>
//               <div className="h-8 border-b-2 border-gray-300">
//                 {reportData?.approverNameAndTitle}
//               </div>
//             </div>
//             <div>
//               <label className="text-sm font-semibold text-gray-600">
...
const WorkOrderReport = () => {
  ...
  const generatePDF = () => {
    ...
    pdf.setFontSize(10);
    pdf.setFont("montserrat", "normal");
    pdf.text("123 Industrial Way • Tech City, TC 12345", pageWidth / 2, yPos, { align: "center" });
    yPos += 5;  // Space below address
    pdf.text("(555) 987-6543 • www.koan-technical.com", pageWidth / 2, yPos, { align: "center" });
